        ...
        <div class="row">
                ...
                <div class="dmne-sidebar">
                    <div class="widget widget-select-inner">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="single-form-check form-check">
                                    <input class="form-check-input" type="checkbox" value="{{ $category->CategoryID }}" id="flexCheckDefault{{ $category->CategoryID }}" data-filter="category-{{ $category->CategoryID }}">
                                    <label class="form-check-label" for="flexCheckDefault{{ $category->CategoryID }}">
                                        {{ $category->CategoryName }} <span>({{ $category->CourseCount }})</span>
                                    </label>
                                </div>
                            </li>
                            @endforeach
            ...
            <div class="col-lg-9">
                <div class="row" id="course-list">
                    ...
                    <div class="col-xl-4 col-md-6 course-item" data-category="category-{{ $course->CategoryID }}" data-level="level-{{ strtolower($course->Level) }}">
