        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                <div class="instructor-details-area text-center">
                    <div class="thumb">
                        <img src="<?php echo e($instructorWithCourses[0]->ImageURL); ?>" alt="Instructor Image">
                    </div>
                    <h3><?php echo e($instructorWithCourses[0]->InstructorName); ?></h3>
                    <p><?php echo e($instructorWithCourses[0]->InstructorType); ?></p>
                    ...
                    <ul class="achivement-fact">
                        <li class="ratting">
                            <div class="icon">
                                <img src="<?php echo e(asset('client/img/icon/star.png')); ?>" alt="img">
                            </div>
                            <h5 class="counter"><?php echo e($instructorWithCourses[0]->Rating); ?></h5>
                            <p>Ratings</p>
                        </li>
                        <li class="students">
                            <div class="icon">
                                <img src="<?php echo e(asset('client/img/icon/user.png')); ?>" alt="img">
                            </div>
                            <h5 class="counter"><?php echo e($instructorWithCourses[0]->EnrolledLearner); ?></h5>
                            <p>Students Learning</p>
                        </li>
                        <li class="courses">
                            <div class="icon">
                                <img src="<?php echo e(asset('client/img/icon/book.png')); ?>" alt="img">
                            </div>
                            <h5 class="counter"><?php echo e(count($instructorWithCourses)); ?></h5>
                            <p>Courses</p>
                        </li>
                    </ul>
                    <div class="text-start px-30">
                        <h5>About Me</h5>
                        <p><?php echo e($instructorWithCourses[0]->InstructorResume); ?></p>
                    </div>
                    <div class="education-qualification">
                        <h5>Education</h5>
                        <ul>
                            <?php $__currentLoopData = json_decode($instructorWithCourses[0]->InstructorDegrees, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $degree): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($degree); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    <div class="text-start px-30">
                        <h5>Scientific Background</h5>
                        <?php $__currentLoopData = json_decode($instructorWithCourses[0]->InstructorScientificBackground, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($field); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="text-start px-30">
                        <h5>Workplace</h5>
                        <p><?php echo e($instructorWithCourses[0]->InstructorWorkplace); ?></p>
                    </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row" id="course-list">
                            <?php $__currentLoopData = $instructorWithCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6">
                                <div class="single-course-wrap">
                                    <div class="thumb">
                                        <a href="#" class="cat cat-blue"><?php echo e($course->Level); ?></a>
                                        <img src="<?php echo e($course->ImageURL); ?>" alt="Course Image">
                                    </div>
                                    <div class="wrap-details">
                                        <h6><a href="#"><?php echo e($course->CourseTitle); ?></a></h6>
                                        <div class="user-area">
...
#pagination .page-link:focus {
    ...
    $(document).ready(function() {
        ...
        var courses = <?php echo json_encode($instructorWithCourses, 15, 512) ?>; // Assuming $instructorWithCourses is already JSON encoded in PHP
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="single-course-wrap">
                                    <div class="thumb">
                                        ...
                                        <img src="<?php echo e(asset('client/img/course/5.png')); ?>" alt="img">
                                    </div>
                                    <div class="wrap-details">
                            ...
                            <div class="col-md-6">
                                <div class="single-course-wrap">
                                    <div class="thumb">
                                        <a href="#" class="cat cat-blue">Beginner</a>
                                        <img src="<?php echo e(asset('client/img/course/4.png')); ?>" alt="img">
                                    </div>
                                    <div class="wrap-details">
        ...
        <div class="row justify-content-center pd-top-120">
            <div class="col-lg-4 col-sm-6">
                <div class="single-intro-wrap-2">
                    <div class="thumb">
                        <img src="<?php echo e(asset('client/img/intro/01.png')); ?>" alt="img">
                    </div>
                    <div class="wrap-details">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single-intro-wrap-2">
                    <div class="thumb">
                        <img src="<?php echo e(asset('client/img/intro/02.png')); ?>" alt="img">
                    </div>
                    <div class="wrap-details">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single-intro-wrap-2">
                    <div class="thumb">
                        <img src="<?php echo e(asset('client/img/intro/03.png')); ?>" alt="img">
                    </div>
                    <div class="wrap-details">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                                <div class="thumb">
                                    <img src="<?php echo e(asset('client/img/about/1.png')); ?>" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="testimonial-slider owl-carousel">
                    <div class="item">
                        <div class="single-testimonial-wrap">
                            <div class="thumb">
                                <img src="<?php echo e(asset('client/img/quote.png"')); ?> alt="img">
                            </div>
                            <div class="wrap-details">
...
<?php echo $__env->make('inc.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trang\OneDrive\Máy tính\2m\online_learning\resources\views/instructor_details.blade.php ENDPATH**/ ?>