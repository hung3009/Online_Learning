...
<div class="signin-area pd-top-130 pd-bottom-100">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5">
                <form class="single-signin-form-wrap" method="POST" action="<?php echo e(route('login')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bottom-content">
                        ...
                        <a class="strong" href="<?php echo e(route('register')); ?>">Signup</a>
                    </div>
                </form>
...
<?php echo $__env->make('inc.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trang\OneDrive\Máy tính\2m\online_learning\resources\views/login.blade.php ENDPATH**/ ?>