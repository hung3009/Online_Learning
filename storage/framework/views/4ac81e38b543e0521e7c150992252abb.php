    ...
    <div class="admin-dashboard-right-side">
        ...
        <div class="dashboard-course-area">
            <div class="row">
                ...
                <form method="POST" action="<?php echo e(route('instructor.courses.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-lg-12">
...
<?php echo $__env->make('instructor.inc.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trang\OneDrive\Máy tính\2m\online_learning\resources\views/instructor/create_course.blade.php ENDPATH**/ ?>