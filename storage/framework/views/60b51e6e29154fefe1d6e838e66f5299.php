<?php $__env->startSection('content'); ?>
    ...
    <div class="signin-area pd-top-130 pd-bottom-100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <form class="single-signin-form-wrap" method="POST" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('inc.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trang\OneDrive\Máy tính\2m\online_learning\resources\views/register.blade.php ENDPATH**/ ?>