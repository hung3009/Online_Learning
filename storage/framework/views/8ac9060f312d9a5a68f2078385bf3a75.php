...
<section class="enllor-courses-area pd-top-120 pd-bottom-140">
    <div class="container">
        ...
        <form action="<?php echo e(route('checkout.process')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="order-details p-3 mb-3" style="background-color: #f9f9f9; border-radius: 5px;">
                        ...
                        <div class="order-item d-flex align-items-center">
                            <img src="<?php echo e(asset('storage/' . $course->ImageURL)); ?>" alt="Course Image" class="img-thumbnail" style="width: 100px; height: auto; margin-right: 15px;">
                            <div>
                                <p><?php echo e($course->Title); ?></p>
                                <p><?php echo e(number_format($course->Price, 2)); ?>$</p>
                            </div>
                        </div>
                        <input type="hidden" name="course_id" value="<?php echo e($course->CourseID); ?>">
                        <input type="hidden" name="course_price" value="<?php echo e($course->Price); ?>">
                    </div>
                </div>
...
<?php echo $__env->make('inc.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trang\OneDrive\Máy tính\2m\online_learning\resources\views/checkout.blade.php ENDPATH**/ ?>